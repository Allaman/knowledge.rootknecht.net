...
### Enable https
In gitlab.rb put 'external_url "https://gitlab.example.com"'. Gitlab will look after your certificates according to your hostname here in `/etc/gitlab/ssl/gitlab.example.com.key` and your cert in `/etc/gitlab/ssl/gitlab.example.com.crt`.
